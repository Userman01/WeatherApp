//
//  DetailTableForecastForDaysCell.swift
//  WetherApp
//
...
class DetailTableForecastForDaysCell: UITableViewCell {
    ...
    func configure(with viewModel: DetailforecastForDaysViewModelCell) {
        getLabel().text = viewModel.dataAndTime
